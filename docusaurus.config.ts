...
const config: Config = {
  ...
  projectName: "kanthor-docs", // Usually your repo name.
    ...
    [
      "classic",
      {
        docs: {
          ...
          editUrl: "https://github.com/kanthorlabs/kanthor-docs/edit/main/",
        },
        blog: {
  ...
  themeConfig: {
    ...
    footer: {
      ...
      copyright: `Copyright © ${new Date().getFullYear()} Kanthor, Inc. Built with Docusaurus.`,
    },
    prism: {
